...
# Capital VA Youth Volunteer Hours (OUTLIERS)
# Redcross Internship 
...
# Get Outliers from original data set
...
png("/Users/yixintang/Redcross/Capital VA Youth/Number_of_Volunteers(outliers).png")
ggplot(capital_r, aes(x=forcats::fct_infreq(Race),fill=factor(Gender)))+
  ...
  scale_fill_manual(values=c('pink','light blue'),name="Gender",
                    na.value = "grey")+
  labs(x="Race", 
       title="Capital VA Youth Volunteers \nNumber of Volunteers by Race&Gender (Outliers)", 
       size=12)+
  geom_text(aes(label=..count..),stat='count',
            position=position_dodge(0.9),vjust=-0.2)
dev.off()
...
png("/Users/yixintang/Redcross/Capital VA Youth/Total_Hour(outliers).png")
ggplot(data=TH_race_gender,aes(x=reorder(Race,-total_hour),
  ...
  scale_fill_manual(values=c('pink','light blue'),
                    name="Gender",na.value = "grey")+
  labs(x="Gender", 
       title="Capital VA Youth Volunteers \nTotal Hours by Race&Gender (Outliers)", 
       size=12)+
...
png("/Users/yixintang/Redcross/Capital VA Youth/Average_Hour(outliers).png")
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_total(outliers).png")
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_number(outliers).png")
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_average(outliers).png")
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_total(specific)(outliers).png")
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_number(specific)(outliers).png")
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_averaged(specific)(outliers).png")
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_number_r(outliers).png")
ggplot(capital_i, aes(x=forcats::fct_infreq(Race),
  ...
  scale_fill_viridis(discrete=TRUE,name="General Activity Category",na.value = "grey")+
  labs(x="Race", 
       title="Capital VA Youth Volunteers \nActivity: Number of Occurrences (General)(Outliers)", 
       size=12)+
  geom_text(aes(label=..count..),stat='count',
            position=position_dodge(0.9),vjust=-0.2)
dev.off()
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_total_r(outliers).png")
ggplot(data=TH_race_act,aes(x=reorder(Race,-total_hour),
  ...
  scale_fill_viridis(discrete=TRUE,name="General Activity Category",na.value = "grey")+
  labs(x="Race", 
       title="Capital VA Youth Volunteers \nActivity: Total Hours (General)(Outliers)", 
       size=12)+
  geom_text(aes(label=total_hour), vjust=-0.3, size=3.5,
            position = position_dodge(0.9))
dev.off()
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_average_r(outliers).png")
ggplot(data=TH_race_act,aes(x=reorder(Race,-Average),
  ...
  scale_fill_viridis(discrete=TRUE,name="General Activity Category",na.value = "grey")+
  labs(x="Race", 
       title="Capital VA Youth Volunteers \nActivity: Averaged Hours (General)(Outliers)", 
       size=12)+
  geom_text(aes(label=round(Average,2)), vjust=-0.3, size=3.5,
            position = position_dodge(0.9))
dev.off()
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_number_r(specific)(outliers).png")
# Number of Occurrences by Race(General Activity Category)
ggplot(act_specific_full, aes(x=forcats::fct_infreq(Race),
  ...
  scale_fill_manual(values=mycolors,name="Specific Activity",na.value = "grey")+
  labs(x="Race", 
       title="Capital VA Youth Volunteers \nActivity: Number of Occurrences (Specific)(Outliers)", 
       size=12)+
  geom_text(aes(label=..count..),stat='count',
            position=position_dodge(0.9),vjust=-0.2)
dev.off()
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_total_r(specific)(outliers).png")
ggplot(data=act_specific_r,aes(x=reorder(Race,-total_hour),
                               y=total_hour,fill=factor(Activity_specific))) + 
  geom_bar(stat="identity",width=0.7,position=position_dodge())+
  theme(axis.text.x = element_text(angle = 30, size=9, vjust=1, hjust=1))+
  scale_fill_manual(values=mycolors,name="Specific Activity",na.value = "grey")+
  labs(title="Capital VA Youth Volunteers \nActivity: Total Hours (Specific)(Outliers)", 
       size=12,
       x="Race",
       y="Total Number of Hours(Specific Activity)")+
  geom_text(aes(label=total_hour), vjust=-0.3, size=3.5,
...
png("/Users/yixintang/Redcross/Capital VA Youth/Act_average_r(specific)(outliers).png")
ggplot(data=act_specific_r,aes(x=reorder(Race,-Average),
  ...
  scale_fill_manual(values=mycolors,name="Specific Activity",na.value = "grey")+
  labs(x="Activity", 
       title="Capital VA Youth Volunteers \nActivity: Averaged Hours (Specific)(Outliers)", 
       size=12)+
  geom_text(aes(label=round(Average,2)), vjust=-0.3, size=3.5,
            position = position_dodge(0.9))
dev.off()
