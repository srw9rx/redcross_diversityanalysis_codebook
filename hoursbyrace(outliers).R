...
png("/Users/yixintang/Redcross/Demographics/Number_of_Volunteers(outliers).png")
...
png("/Users/yixintang/Redcross/Demographics/Total_Hour(outliers).png")
...
png("/Users/yixintang/Redcross/Demographics/Average_Hour(outliers).png")
...
ggplot(data=race,aes(x=race,y=`hours worked since 8/1/20`,color=factor(gender)))+
  ...
  labs(x="Race", 
       title="Boxplot: Hours by Race/Gender", 
       size=12)
